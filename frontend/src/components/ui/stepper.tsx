  ...
  return (
    <Button
      ...
      className={cn(
        ...
        'data-[active=true]:bg-foreground data-[active=true]:border-foreground data-[active=true]:text-secondary dark:data-[active=true]:text-primary',
        'data-[current=true]:border-foreground data-[current=true]:bg-secondary',
